...
const { getWalletOverview, getWalletWithdraw, getAgentCommissionOverview, agentCommissionWithdraw } = require("../controllers/Users/walletServiece/walletServies");
...
router.get("/agent-overview/:memberId", Authenticated, getAgentCommissionOverview);
router.post("/withdraw/:memberId", Authenticated, getWalletWithdraw);
router.post("/agent-withdraw/:memberId", Authenticated, agentCommissionWithdraw);
